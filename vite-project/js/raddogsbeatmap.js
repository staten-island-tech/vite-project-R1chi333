...
function missthingy() {
  ...
  console.log(ahhhnote);
  setTimeout(() => {
    theplace = ahhhnote.getBoundingClientRect();
    if (theplace.top >= 900) {
      combo = 0;
      combomultiplier = 0.99;
...
function greenishbeatmap() {
  setTimeout(() => {
    el.insertAdjacentHTML(
      "afterend",
      `<div id="ahhhnote" class="note note4 down"></div>`
    );
    missthingy();
  }, 12200);
  setTimeout(() => {
    el.insertAdjacentHTML(
      "afterend",
      `<div id="ahhhnote" class="note note1 down"></div>`
    );
    missthingy();
  }, 12700);
  setTimeout(() => {
    el.insertAdjacentHTML(
      "afterend",
      `<div id="ahhhnote" class="note note2 down"></div>`
    );
    missthingy();
  }, 13000);
  setTimeout(() => {
  ...
  setTimeout(() => {
    el.insertAdjacentHTML(
      "afterend",
      `<div id="ahhhnote" class="note note3 down"></div>`
    );
    missthingy();
  }, 17700);
  setTimeout(() => {
...
export let combomultiplier = 0.99;
