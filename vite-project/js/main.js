...
function themes() {
    if (theme === 0){
        DOMSelectors.changeartist.insertAdjacentElement("afterend", DOMSelectors.starttext)
    }
    if (theme === 1){
        DOMSelectors.artist.insertAdjacentHTML("afterend", `<div class="close" id="planet-ring">
        ...
        canvas.insertAdjacentHTML("afterend",`<div id="audios"><audio class="audio" id="erhu" src="kuritism/erhu.mp3"></audio></div>`)        
        const erhu = document.getElementById("erhu")
